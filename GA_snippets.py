...
path[24] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 24 NRRD/Manual/2013-02-25-Scene-without-CtrPt.mrml'
path[29] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 29 NRRD/Manual/2013-02-26-Scene-without-CtrPts.mrml'
path[30] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 30 NRRD/Manual/2013-02-26-Scene-without-CtrPt.mrml'
path[31] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 31 NRRD/Manual/2013-02-27-Scene-without-CtrPts.mrml'
path[34] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 34 NRRD/Manual/2013-02-27-Scene-without-CtrPts.mrml'
path[35] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 35 NRRD/Manual/2013-02-27-Scene-without-CtrPts.mrml'
path[37] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 37 NRRD/Manual/2013-02-27-Scene-without-CtrPts.mrml'
path[38] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 38 NRRD/Manual/2013-02-27-Scene-without-CtrPts.mrml'
path[40] = '/Users/GP1514/Dropbox/AMIGO Gyn Data NRRD (1)/Case 40 NRRD/Manual/2013-02-27-Scene-without-CtrPts.mrml'
...
def costFunction(chrm,caseID, writeResults = True):
  ...
  if writeResults:
    l.exportEvaluation(results, '/Users/GP1514/Projects/github/NeedleFinderProjectWeek/'+str(caseID)+'.csv')
  HD=np.array(results)
  # print HD
  cost = np.sum(HD[:,0]>2)
  # cost = 1
  ...
  for generation in range(nbOfGenerations):
    ...
    for i in range(len(sample_pop)):
      ...
      if not sample_pop[i] in tried_params: #to avoid doing several times the same calculation
        ...
        l.exportEvaluation(params+[fitness], '/Users/GP1514/Projects/github/NeedleFinderProjectWeek/'+str(caseID)+'-fitness.csv')
        # print fitness_list
        ...
        print '\t\tskipped'
    #selection
    selected = [np.random.randint(0,len(sample_pop))]
    size = len(sample_pop) #*0.75
    for i in xrange(size):
      rn = random.random()
      for j, cum_prob in enumerate(cum_prob_list):
        if rn<= cum_prob and j not in selected:
          selected.append(j)
          break
    # simple crossover (1 point)
    parent1=sample_pop[selected[0]]
    parent2=sample_pop[selected[1]]
    # print selected
    # print 'parent'
    # print parent1
    # print parent2
    ...
    # print 'first offsprings:'
    # print offspring1, offspring2
    if not offspring1 in sample_pop: sample_pop.append(offspring1)
    if not offspring2 in sample_pop: sample_pop.append(offspring2)
